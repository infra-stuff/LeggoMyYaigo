import { Message, Client, GatewayIntentBits, TextBasedChannel } from "discord.js";
...
//
async function fetchAllMessages(channelid: string, messageid: string) {
